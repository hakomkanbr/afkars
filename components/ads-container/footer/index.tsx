            ...
            <Container>
                <Row>
                    ...
                    <Col sm={{ span: 12 }} md={{ span: 14 }}>
                        <Text color="#fff" as="h1">Applighterz</Text>
                        <Text color="#fff" as="p" padding={[0, 0, 0, 50]}>توفر منصة Applighterz للتجارة الإلكترونية للشركات جميع الأدوات والخدمات المهنية التي يحتاجونها للبيع عبر الإنترنت وفي المتجر.</Text>
                    </Col>
                </Row>
            </Container>
        </FooterStyle>
